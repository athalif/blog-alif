                    ...
                    <div class="row flex-column">
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card bg-warning text-dark">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-dark stretched-link" href="viewArticle.php">Lihat</a>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card bg-warning text-dark ">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-dark stretched-link" href="viewCategories.php">Lihat
                                    </a>
                                    <div class="small text-dark">
                                        <i class="fas fa-angle-right"></i>
                                    </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card bg-warning text-dark">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-dark stretched-link" href="viewAdmin.php">Lihat</a>
                                    <div class="small text-dark">
                                        <i class="fas fa-angle-right"></i>
                                    </div>
                                </div>
