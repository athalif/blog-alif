...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand ps-3" href="index.php">Beranda</a>
        <!-- Sidebar Toggle-->
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal"
                        data-bs-target="#tambah">Tambah Kategori</button>
                    <br><br>
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-table me-1"></i> Daftar Kategori:</div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#cathapus<?= $no ?>">Hapus</a>
                                        </td>
                                    </tr>
                                                ...
                                                <form action="act_category.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group">
                                                            <label class="control-label" for="nama_kategori">Nama Kategori
                                                                </label>
                                                            <input type="text" class="form-control" name="tkategori"
                                                                value="<?= $row['nama_kategori'] ?>" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label" for="ket">Kategori
                                                                Deskripsi</label>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="act_category.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            <h5 class="text-center">Kategori akan dihapus permanen
                                                                 <br><span
                                                            ...
                                                            <button type="button" class="btn btn-primary"
                                                                data-bs-dismiss="modal">Close</button>
                                                            <button class="btn btn-primary" type="submit"
                                                                name="catdelete">Hapus Kategori</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="act_category.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label" for="keterangan">Deskripsi Kategori</label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-primary"
                                            data-bs-dismiss="modal">Close</button>
                                        <button class="btn btn-primary" type="submit" name="catsave">Tambah
                                            Kategori</button>
                                    </div>
                                </div>
                            </form>
